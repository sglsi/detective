	...
	return [
		...
		# ───────────────────────── 场景六 ─────────────────────────
		{
			...
			"nodes": [
				...
				{"id": "H6-01", "layer": "hypo"}, {"id": "H6-07", "layer": "hypo"},
				{"id": "CL6-1", "layer": "concl"},
			],
			"edges": [
				{"from": "C_SOTCB_603", "to": "H6-01", "kind": "support"},
				{"from": "C_SOTCB_605", "to": "H6-01", "kind": "support"},
				{"from": "C_SOTCB_603", "to": "H6-07", "kind": "support"},
				{"from": "C_SOTCB_605", "to": "H6-07", "kind": "support"},
				{"from": "H6-01", "to": "CL6-1", "kind": "support"},
				{"from": "H6-07", "to": "CL6-1", "kind": "support"},
			],
			"misleads": [{"id": "H6-05", "expect": "negate"}, {"id": "H6-06", "expect": "negate"}],
		},
		{
			"id": "CH09C", "name": "哈珀证词", "scene": "scene6", "core": false,
			"nodes": [
				{"id": "C_SOTCB_604", "layer": "clue"},
				{"id": "H6-02", "layer": "hypo"}, {"id": "H6-09", "layer": "hypo"},
				{"id": "CL6-2", "layer": "concl"},
			],
			"edges": [
				{"from": "C_SOTCB_604", "to": "H6-02", "kind": "support"},
				{"from": "C_SOTCB_604", "to": "H6-09", "kind": "support"},
				{"from": "H6-02", "to": "CL6-2", "kind": "support"},
				{"from": "H6-09", "to": "CL6-2", "kind": "support"},
			],
			"misleads": [],
		},
		...
		# ───────────────────────── 场景七 ─────────────────────────
		{
			...
			"nodes": [
				...
				{"id": "C_SOTCB_707", "layer": "clue"}, {"id": "C_SOTCB_708", "layer": "clue"},
				{"id": "H7-01", "layer": "hypo"}, {"id": "H7-02", "layer": "hypo"}, {"id": "H7-03", "layer": "hypo"},
				{"id": "H7-04", "layer": "hypo"}, {"id": "H7-05", "layer": "hypo"}, {"id": "H7-06", "layer": "hypo"},
				{"id": "H7-12", "layer": "hypo"},
				{"id": "CL7-1", "layer": "concl"}, {"id": "CL7-3", "layer": "concl"},
			],
			"edges": [
				{"from": "C_SOTCB_701", "to": "H7-02", "kind": "support"},
				{"from": "C_SOTCB_702", "to": "H7-01", "kind": "support"},
				{"from": "C_SOTCB_703", "to": "H7-03", "kind": "support"},
				{"from": "C_SOTCB_703", "to": "H7-05", "kind": "support"},
				{"from": "C_SOTCB_706", "to": "H7-01", "kind": "support"},
				{"from": "C_SOTCB_706", "to": "H7-12", "kind": "support"},
				{"from": "C_SOTCB_707", "to": "CL7-1", "kind": "support"},
				{"from": "C_SOTCB_708", "to": "H7-06", "kind": "support"},
				{"from": "H7-01", "to": "CL7-1", "kind": "support"},
				{"from": "H7-02", "to": "CL7-1", "kind": "support"},
				{"from": "H7-03", "to": "CL7-1", "kind": "support"},
				{"from": "H7-05", "to": "CL7-1", "kind": "support"},
				{"from": "H7-04", "to": "CL7-3", "kind": "support"},
				{"from": "H7-12", "to": "CL7-3", "kind": "support"},
			],
			"misleads": [{"id": "H7-08", "expect": "negate"}],
		},
		{
			"id": "CH09E", "name": "药丸推理", "scene": "scene7", "core": true,
			"nodes": [
				{"id": "C_SOTCB_704", "layer": "clue"}, {"id": "C_SOTCB_710", "layer": "clue"},
				{"id": "H7-02", "layer": "hypo"}, {"id": "H7-11", "layer": "hypo"},
				{"id": "CL7-2", "layer": "concl"},
			],
			"edges": [
				{"from": "C_SOTCB_704", "to": "H7-02", "kind": "support"},
				{"from": "C_SOTCB_710", "to": "H7-02", "kind": "support"},
				{"from": "C_SOTCB_704", "to": "H7-11", "kind": "support"},
				{"from": "C_SOTCB_710", "to": "H7-11", "kind": "support"},
				{"from": "H7-02", "to": "CL7-2", "kind": "support"},
				{"from": "H7-11", "to": "CL7-2", "kind": "support"},
			],
			"misleads": [],
		},
