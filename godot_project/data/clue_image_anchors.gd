...
const ANCHORS := {
    ...
    # 2026-08-14：地点类线索与背景图有机结合，锚点框由热点矩形（x,y,w,h）
    # 直接归一化得到：cx=(x+w/2)/1920, cy=(y+h/2)/1080, w=w/1920, h=h/1080。
    # 这保证点击区域、提示圈、放大裁切区域三者中心重合。
    "res://assets/scenes/sc_02_garden.png": {
        "c201": {"cx": 0.58594, "cy": 0.66759, "w": 0.07813, "h": 0.03889},  # 碾轧的花草
        "c202": {"cx": 0.69010, "cy": 0.66759, "w": 0.07813, "h": 0.03889},  # 平行车轮印
        "c203": {"cx": 0.58594, "cy": 0.71389, "w": 0.07813, "h": 0.03889},  # 右前蹄新蹄铁
        "c204": {"cx": 0.69010, "cy": 0.71389, "w": 0.07813, "h": 0.03889},  # 马蹄印迹零乱
        "c205": {"cx": 0.58594, "cy": 0.76019, "w": 0.07813, "h": 0.03889},  # 两组不同脚印
        "c206": {"cx": 0.69010, "cy": 0.76019, "w": 0.07813, "h": 0.03889},  # 步伐距离差异
    },
