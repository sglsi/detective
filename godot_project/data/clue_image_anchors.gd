...
const ANCHORS := {
    ...
    "res://assets/characters/messenger/messenger_portrait.png": {
        "tattoo":  {"cx": 0.13, "cy": 0.18, "w": 0.12, "h": 0.08},  # 手背锚形文身（画面左侧前伸的右手背）
        "beard":   {"cx": 0.49, "cy": 0.105, "w": 0.16, "h": 0.07}, # 络腮胡（下颌/胡须中心）
        "posture": {"cx": 0.50, "cy": 0.50, "w": 1.00, "h": 1.00},  # 笔挺站姿（全身）
        "manner":  {"cx": 0.49, "cy": 0.055, "w": 0.16, "h": 0.06}, # 发号施令神态（眉眼区域）
