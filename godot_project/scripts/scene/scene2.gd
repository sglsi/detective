...
const PATH_HOTSPOTS = [
	{"id":"c205","attribute_tags":["直接物证"],"label":"两组不同脚印","x":731,"y":584,"w":150,"h":42,
	 ...
	 "image":"res://assets/scenes/sc02_path.png","anchor":"c205","relation_tags":["H2-04","H2-06","C2-01"]},
...
func _on_observe_complete() -> void:
	_ui.set_dialogue("华生", "福尔摩斯，花园里的痕迹全都记录好了——轴距6英尺10英寸的车轮印、右前蹄的新蹄铁、两组不同步幅的足迹……证据很充足。", "思考")
...
func reasoning_hypothesis() -> Dictionary:
	return {
		...
		"hypotheses": [
			...
			{"id":"H2-04","text":"案发当晚有两个人来过（一高一矮）","kind":"true","correct":true,"dir":"affirm","subject":["来客"],"object":["两个人","步幅"],
			 "gate_clue_ids":["c205","c206"],
				 "adopt_desc":"泥地里有两组明显不同步幅的脚印（约4.5英尺与3.5英尺），部分叠在另一部分上面且都在警察脚印之下——夜间来客共两人，都比警察的脚印早。",
				 "new_clue_hint":""},
			{"id":"H2-05","text":"其中一人身高约6英尺（范围估计）","kind":"true","correct":true,"dir":"affirm","subject":["高个子"],"object":["身高","6英尺"],
			 "gate_clue_ids":["c206"],
				 "adopt_desc":"步幅4.5英尺按步幅/身高比0.45推算，身高约6英尺（183cm）。步幅骗不了人。",
				 "new_clue_hint":"知识库·步态与身高：一般成年男性步幅约为身高的0.45倍。"},
		...
		"conclusions": [
			...
			{"id":"CL2-5","text":"夜间来客共两人，一高一矮","kind":"true","dir":"affirm","subject":["来客"],"object":["两个人","一高一矮"],"gate_hypo_ids":["H2-04"],
			 "adopt_desc":"两组不同步幅的脚印叠压在警察脚印之下——两个来客，一个大步子，一个小步子。"},
			{"id":"CL2-6","text":"高个子身高约6英尺、穿方头靴","kind":"true","dir":"affirm","subject":["高个子"],"object":["6英尺","方头靴"],"gate_hypo_ids":["H2-05","H2-06"],"target":"person:KILLER",
			 "adopt_desc":"步幅推算身高约6英尺，方头靴是体力活的穿法——高个子体貌的关键观察结论（范围估计，不作定论）。"},
			...
			{"id":"CL2-2M","text":"来客身材矮小、体格瘦弱","kind":"mislead","dir":"affirm","subject":["来客"],"object":["矮小","瘦弱"],"gate_hypo_ids":["H2-05"],
			 "reject_desc":"现场大步幅（约4.5英尺→身高6英尺）与印痕深度均指向高大强壮者，与矮小瘦弱矛盾。"},
