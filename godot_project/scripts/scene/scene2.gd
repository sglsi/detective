...
func reasoning_hypothesis() -> Dictionary:
	return {
		...
		"conclusions": [
			{"id":"CL2-1","text":"来的是一辆出租马车","kind":"true","dir":"affirm","subject":["出租马车"],"object":["轴距","3.8英尺"],"gate_hypo_ids":["H2-01"],
			 "adopt_desc":"三链之一：轴距3.8英尺符合伦敦出租四轮马车——私家马车不会这么窄，因为它们不钻小巷。"},
		...
		"milestones": [
			...
			{"id":"S2-2","text":"来的是一辆出租马车（轴距3.8英尺）"},
