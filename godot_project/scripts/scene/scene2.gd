...
const PATH_HOTSPOTS = [
	...
	{"id":"c206","attribute_tags":["直接物证"],"label":"步伐距离差异","x":923,"y":735,"w":150,"h":42,
	 "desc":"卷尺测量步长（一左一右两个脚印之间的距离）：方头靴约2.6~2.9英尺，尖头漆皮靴约2.2~2.5英尺。查知识库·步长与身高（步长约为身高的0.45倍，贝蒂荣）：2.75英尺→身高约6英尺（183cm）；2.35英尺→身高约5英尺3英寸（160cm）。两串脚印的步长差出一截——一个高大，一个轻小。","tool":"卷尺",
	...
	{"id":"c210","attribute_tags":["直接物证"],"label":"尖头漆皮靴印","x":1200,"y":380,"w":150,"h":42,
	 "desc":"卷尺与放大镜：尖头漆皮靴印长10.5英寸、宽3.25英寸，印痕深仅约0.5英寸——明显比那双方头靴浅。鞋型窄长、鞋头尖细、后跟细窄，漆皮表面光洁，是体面人士的正装靴。查知识库·步长与身高：鞋印短窄、落脚又浅，说明此人身材轻小，身高约5英尺3英寸（160厘米）。","tool":"卷尺",
...
func _on_observe_complete() -> void:
	_ui.set_dialogue("华生", "福尔摩斯，花园里的痕迹全都记录好了——轴距6英尺10英寸的车轮印、右前蹄的新蹄铁、两串并肩的脚印（方头靴11.5英寸、尖头漆皮靴10.5英寸），还有一进一出与只进不出的行踪……证据很充足。", "思考")
	...
	return {
		...
		"hypotheses": [
			...
			{"id":"H2-04","text":"案发当晚有两个人来过（一高一矮）","kind":"true","correct":true,"dir":"affirm","subject":["来客"],"object":["两个人","步长"],
			 "gate_clue_ids":["c205","c206"],
				 "adopt_desc":"泥地里有两组明显不同的脚印，彼此挨得很近、部分叠压且都在警察脚印之下——夜间来客共两人，都比警察的脚印早。方头靴那串长11.5英寸、步长约2.6~2.9英尺；尖头漆皮靴那串长10.5英寸、步长约2.2~2.5英尺。",
				 "new_clue_hint":""},
			...
			{"id":"H2-08","text":"两个来客是并肩同行抵达的（相距很近）","kind":"true","correct":true,"dir":"affirm","subject":["来客"],"object":["并肩","同行"],
			 "gate_clue_ids":["c205"],
				 ...
				 "new_clue_hint":""},
			{"id":"H2-09","text":"穿尖头漆皮靴的是个身材轻小的人（身高约5英尺3英寸）","kind":"true","correct":true,"dir":"affirm","subject":["矮个子"],"object":["身高","5英尺3英寸","轻小"],
			 "gate_clue_ids":["c210","c206"],
				 "adopt_desc":"尖头漆皮靴那串步长2.2~2.5英尺（中值2.35）→身高约5英尺3英寸（160cm）；鞋印仅长10.5英寸、印深约0.5英寸，明显比方头靴浅——鞋型窄长、落脚轻，是个体态轻小的体面人士。",
				 "new_clue_hint":"知识库·步长与身高：鞋印短窄、压痕浅都与体格轻小相符。"},
		...
		"conclusions": [
			...
			{"id":"CL2-5","text":"夜间来客共两人，一高一矮","kind":"true","dir":"affirm","subject":["来客"],"object":["两个人","一高一矮"],"gate_hypo_ids":["H2-04"],
				 "adopt_desc":"两串脚印挨得极近、叠压在警察脚印之下——两个来客，一个步长2.6~2.9英尺，一个2.2~2.5英尺。"},
			...
			{"id":"CL2-8","text":"另一位来客是身高约5英尺3英寸的轻小个子","kind":"true","dir":"affirm","subject":["矮个子"],"object":["5英尺3英寸","轻小"],
			 "gate_hypo_ids":["H2-09"],
				 "adopt_desc":"尖头漆皮靴那串步长2.2~2.5英尺、印长10.5英寸、印深0.5英寸——身高约5英尺3英寸，体态轻小、穿着体面。"},
