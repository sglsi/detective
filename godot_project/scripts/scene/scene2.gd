...
const HOTSPOTS = [
	...
	# 2026-08-14：热点坐标调整到 wet road 区域（x=1050/1250, y=700/750/800），
	# 与 sc_02_garden.png 的可见路面内容对应；每个热点都带 image+anchor，
	# 观察时会放大显示背景对应区域，实现线索与背景图的有机结合。
	{"id":"c201","label":"碾轧的花草","x":1050,"y":700,"w":150,"h":42,
	 "desc":"路边草地被压过了——两道平行的印子，草地上有两道平行的凹痕，像是车轮碾轧留下的。有马车在此停靠过。","tool":"none",
	 "image":"res://assets/scenes/sc_02_garden.png","anchor":"c201"},
	{"id":"c202","label":"平行车轮印","x":1250,"y":700,"w":150,"h":42,
	...
	# ── 勘查对象B：马蹄印迹（08稿 六步闭环）──
	{"id":"c203","label":"右前蹄新蹄铁","x":1050,"y":750,"w":150,"h":42,
	...
	{"id":"c204","label":"马蹄印迹零乱","x":1250,"y":750,"w":150,"h":42,
	...
	# ── 勘查对象C：步伐距离（08稿 六步闭环）──
	{"id":"c205","label":"两组不同脚印","x":1050,"y":800,"w":150,"h":42,
	...
	{"id":"c206","label":"步伐距离差异","x":1250,"y":800,"w":150,"h":42,
