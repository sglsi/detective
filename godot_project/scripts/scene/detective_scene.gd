...
func _open_wall(source: String = "", hypothesis: Dictionary = {}, on_verify: Callable = Callable(), on_continue: Callable = Callable(), teaching: bool = false, state_store_override: Dictionary = {}) -> void:
