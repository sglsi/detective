...
func _show_detective_dialogue() -> void:
	...
	_start_dialogue(_make_nodes([
		...
		["j4","福尔摩斯","伪装。凶手想把我们引向'复仇的德国人'。再看笔顺——歪歪扭扭，像左手蘸血随手抹的。华生，戴上你的放大镜，把屋里每样东西都看一遍：尸体、戒指、随身物。"]]), "j0", _on_detective_ended)
...
func _enter_transition() -> void:
	...
	_start_dialogue(_make_nodes([
		...
		["k2","葛莱森","案子比我们想的复杂。接下来去奥德利大院，找找昨晚的巡警问问话。"]]), "k0", _go_to_next_scene)
