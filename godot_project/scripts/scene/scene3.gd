...
const HOTSPOTS = [
	...
	{"id":"c301","label":"尸体·面部与姿态","x":320,"y":150,"w":200,"h":46,
	 "desc":"死者约四十三四岁，中等身材，宽宽的肩膀，黑色鬈发，短硬的胡子。僵硬的脸上露出恐怖、忿恨的表情；紧握双拳、两臂伸开、双腿交叠——临死前有过痛苦的挣扎。放大镜下：面部肌肉扭曲，瞳孔收缩。那种表情，不是一般的死亡。","tool":"放大镜"},
	{"id":"c302","label":"尸体·无外伤+嘴唇暗紫","x":560,"y":150,"w":220,"h":46,
	 "desc":"放大镜检查全身：无明显外伤，衣物完整无破损，指甲缝干净无搏斗痕迹；嘴唇黏膜呈暗紫色，微微张开，有少量泡沫状分泌物和极细的水疱。查知识库·生物碱中毒：可致面部痉挛、嘴唇发绀、瞳孔异常——无外伤+痛苦死亡+嘴唇暗紫，毒杀可能性很大。","tool":"化学试剂盒"},
	{"id":"c303","label":"尸体·衣着整洁","x":810,"y":150,"w":220,"h":46,
	 "desc":"身上穿着背心和厚厚的黑呢礼服上衣，浅色裤子，洁白的硬领和袖口整洁——死者衣着体面，身份不低。","tool":"none"},
	# ══ B 随身物品（08稿 六步闭环 B-Step1~6：九件物品）══
	{"id":"c304","label":"名片夹与两封信","x":1060,"y":150,"w":240,"h":46,
	 "desc":"俄国制皮名片夹，内有名片：伊诺克·J·德雷伯，克利夫兰——与金表背面「E.J.D.」刻字、衬衣缩写三重印证。两封信：一封寄给德雷伯，一封寄给斯特兰森，均来自盖恩轮船公司，通知轮船从利物浦启程的日期——他们正准备乘船回纽约。","tool":"放大镜"},
	{"id":"c305","label":"金表金链与财物","x":1330,"y":150,"w":240,"h":46,
	 "desc":"伦敦巴罗德公司金表、又重又结实的阿尔伯特金链、虎头狗造型红宝石金别针、零钱七英镑十三先令——全部原封未动。死者经济状况良好，且并未遭抢劫，作案动机不在钱财。","tool":"none"},
	{"id":"c306","label":"共济会金戒指","x":320,"y":560,"w":240,"h":46,
	 "desc":"死者手上戴着一枚金戒指，刻着共济会图案，内侧有磨损痕迹——佩戴者通常是共济会成员。查知识库：共济会成员多为中产及以上阶层。","tool":"放大镜"},
	{"id":"c307","label":"袖珍小说《十日谈》","x":600,"y":560,"w":220,"h":46,
	 "desc":"袖珍版薄伽丘《十日谈》，扉页手写着「约瑟夫·斯特兰森」——与信件收件人对上了。斯特兰森是死者的秘书或同伴，两人关系密切。","tool":"放大镜"},
	{"id":"c308","label":"礼帽","x":860,"y":560,"w":200,"h":46,
	 "desc":"一顶整洁的礼帽，内衬标着帽商标记——指向物品购买地点，可循此溯源死者在伦敦的落脚处。","tool":"none"},
	# ══ C 现场痕迹（08稿 六步闭环 C-Step1~6）══
	{"id":"c309","label":"\"RACHE\"血字","x":1100,"y":560,"w":220,"h":46,
	 "desc":"墙角花纸剥落处，黄色粉墙上用鲜血潦草地写着「RACHE」。卷尺测量：离地约6英尺（视线平行高度→书写者身高约6英尺）。放大镜下：笔画边缘有细微墙粉刮痕——写字的人指甲未修剪。查知识库：德语中 RACHE 意为「复仇」。","tool":"放大镜"},
	{"id":"c310","label":"壁炉旁烟灰","x":1330,"y":560,"w":200,"h":46,
	 "desc":"壁炉旁有一小撮烟灰，颜色深黑、呈薄片状，灰烬结构疏松——与普通纸烟的灰白色粉末状烟灰明显不同。查知识库：这是印度雪茄的烟灰特征。但谁抽的，还不能定论。","tool":"放大镜"},
	{"id":"c311","label":"尘土脚印与靴印","x":560,"y":760,"w":220,"h":46,
	 "desc":"地板尘土中有两组不同的脚印：漆皮靴+方头靴——穿漆皮靴的那位，就躺在我们面前；方头靴属于另一个人。卷尺测量步幅约4.5英尺——和花园里的发现对上了：六英尺的高个子，方头靴。","tool":"卷尺"},
	{"id":"c312","label":"女式结婚戒指","x":860,"y":760,"w":200,"h":46,
	 "desc":"搬动尸体时，一枚女式结婚戒指从尸体上滚落——尺码纤细，属于一位女性。它为什么会在死者身上？是死者带来的，还是凶手留下的？雷斯垂德认定这是情杀的铁证，但福尔摩斯不置可否。（关键线索 C_SOTCB_303，关联推理链#9复仇动机）","tool":"none"},
	# ── 沉默线索 D1（自由发现，无对话无任务指引，给洞察之星奖励；详见 02 §11）──
	{"id":"d1_top","label":"墙角杂物堆（木陀螺）","x":320,"y":760,"w":220,"h":46,
	 "desc":"墙角杂物堆深处，一个老旧的木陀螺静静躺着——刻着简单的花纹，漆皮剥落，缠线还在，落满了灰。空屋里的儿童陀螺——这房子以前也住过一家人吧。（沉默线索 D1：自由探索发现，洞察之星+0.5）","tool":"放大镜","silent":true},
]
...
func _show_detective_dialogue() -> void:
	...
	_start_dialogue(_make_nodes([
		["j0","葛莱森","（从门口走进来，拍了拍身上的灰）雷斯垂德，你怎么也来了？这案子是我先找上福尔摩斯先生的。"],
		["j1","雷斯垂德","（反唇相讥，眼睛还盯着墙角）这么大的案子，我不来，某人怕是要走错方向。空屋男尸无伤痕——光靠你那套'查帽子找身份'的老办法，能查到什么时候？"],
		["j2","葛莱森","（脸微微一沉）我已经查明死者身份了。你呢？除了墙上几个字，还发现了什么？"],
		["j3","雷斯垂德","（得意地指着墙角）瞧瞧这个！RACHE——写字的人本来要写 RACHEL，一个女人的名字！"],
		["j4","福尔摩斯","（不置可否，看向华生）你怎么看？","","从容"],
		["j5","福尔摩斯","别急着站队。尸体、物品、痕迹——把屋里每样东西都看一遍，让证据自己说话。","","指导"]]), "j0", _on_detective_ended)
...
func _enter_transition() -> void:
	...
	_start_dialogue(_make_nodes([
		...
		["k4","系统","（演出）福尔摩斯走到门口，吹了一声口哨。一个衣衫褴褛的机灵小子从街角跑了过来。","","guide"],
		["k5","维金斯","（嬉皮笑脸地敬礼）福尔摩斯先生！您找我？"],
