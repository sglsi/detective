...
const HOTSPOTS = [
	...
	{"id":"c301","attribute_tags":["直接物证"],"relation_tags":["H3-01","C-06"],"label":"尸体·面部与姿态","x":840,"y":410,"w":220,"h":46,
	...
	{"id":"c302","attribute_tags":["直接物证"],"relation_tags":["H3-01","C3-01"],"label":"尸体·无外伤+嘴唇暗紫","x":880,"y":460,"w":240,"h":46,
	...
	{"id":"c303","attribute_tags":["直接物证"],"label":"尸体·衣着整洁","x":1000,"y":520,"w":240,"h":46,
	...
	{"id":"c304","attribute_tags":["直接物证"],"label":"名片夹与两封信","x":1220,"y":480,"w":220,"h":46,
	...
	{"id":"c305","attribute_tags":["直接物证"],"label":"金表金链与财物","x":620,"y":500,"w":220,"h":46,
	...
	{"id":"c306","attribute_tags":["直接物证"],"label":"共济会金戒指","x":1260,"y":570,"w":200,"h":46,
	 "desc":"死者手上戴着一枚金戒指，刻着共济会图案，内侧有磨损痕迹——佩戴者通常是共济会成员。查知识库：共济会成员多为中产及以上阶层。","tool":"放大镜","image":"res://assets/scenes/sc_03_indoor_hd.jpg"},
	{"id":"c307","attribute_tags":["直接物证"],"label":"袖珍小说《十日谈》","x":460,"y":550,"w":220,"h":46,
	...
	{"id":"c309","attribute_tags":["直接物证"],"relation_tags":["H3-02","H3-03","H3-04","C3-03","C-06"],"label":"\"RACHE\"血字","x":1450,"y":240,"w":220,"h":46,
	...
	{"id":"c310","attribute_tags":["直接物证"],"label":"壁炉旁烟灰","x":1580,"y":640,"w":200,"h":46,
	...
	{"id":"c311","attribute_tags":["直接物证"],"relation_tags":["H2-05","H2-06"],"label":"尘土脚印与靴印","x":420,"y":720,"w":260,"h":46,
	...
	{"id":"c312","attribute_tags":["直接物证"],"relation_tags":["C3-04"],"label":"女式结婚戒指","x":900,"y":660,"w":220,"h":46,
