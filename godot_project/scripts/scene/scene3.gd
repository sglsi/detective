...
const HOTSPOTS = [
	...
	{"id":"c309","attribute_tags":["直接物证"],"relation_tags":["H2-05","H3-C1","H3-C2","H3-C3","H3-C4","H3-C7","H3-C9","H3-C10","C-06","C3-03"],"label":"\"RACHE\"血字","x":1450,"y":240,"w":220,"h":46,
	 "desc":"墙角花纸剥落处，黄色粉墙上用鲜血潦草地写着「RACHE」。卷尺测量：字迹中心离地约5英尺7英寸半（171厘米）——正落在站立书写者的眼睛高度（站立眼高≈身高×0.94，贝蒂荣人体测量），反推书写者身高约6英尺（183厘米）。放大镜下：笔画边缘有细微墙粉刮痕——写字的人指甲未修剪。查知识库：德语中 RACHE 意为「复仇」。","tool":"放大镜","image":"res://assets/scenes/sc_03_indoor_hd.jpg"},
	...
	{"id":"c311","attribute_tags":["直接物证"],"relation_tags":["H2-05","H2-06","H3-C3","H3-C5","H3-C6","H3-C7"],"label":"尘土脚印与靴印","x":420,"y":720,"w":260,"h":46,
	 "desc":"地板尘土中有两组不同的脚印：漆皮靴+方头靴——穿漆皮靴的那位，就躺在我们面前；方头靴属于另一个人。卷尺测量方头靴步长约2.6~2.9英尺——和花园里的发现对上了：六英尺的高个子，方头靴。","tool":"卷尺","image":"res://assets/scenes/sc_03_indoor_hd.jpg"},
		...
		"battlefield": {
			"hypotheses": [
				...
				{"id":"H3-C3","text":"写字的人身高约六英尺","kind":"true","correct":true,"dir":"affirm","subject":["书写者"],"object":["身高","六英尺"],
				 ...
				 "adopt_desc":"SUPPORTED：血字字迹中心离地约5英尺7英寸半（171厘米），正落在站立书写者的眼睛高度（站立眼高≈身高×0.94）→ 反推书写者身高约6英尺（183cm）；再加方头靴步长2.6~2.9英尺推算——双重印证，但不是精确测量。六英尺的人，方头靴——和花园里的发现对上了。",
				 "new_clue_hint":"知识库·人体测量（KB-B-2）：人在墙面书写时字迹大致落在双眼高度，站立眼高≈身高×0.93~0.94，故书写者身高≈字迹离地高度÷0.94。"},
				...
				{"id":"H3-C7","text":"穿方头靴的那个人个子较高","kind":"true","correct":true,"dir":"affirm","subject":["方头靴者"],"object":["高个","步幅"],
				 ...
				 "adopt_desc":"SUPPORTED：约2.6~2.9英尺的步长属于方头靴那一组，且血字高度由方头靴者书写的可能性大——两者互相印证。",
