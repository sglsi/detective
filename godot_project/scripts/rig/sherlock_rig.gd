# 自动生成：tools/gen_character_rig.py sherlock —— sherlock 绑骨定义
class_name SherlockRig
const DEF := {
	"bones": [
		{"name":"head","parent":"","pos":Vector2(0,0),"rot":0,"len":80,"wid":46,"dir":-1,"color":Color(0.86,0.70,0.55),"tex":"res://assets/characters/sherlock/rig/sherlock_head.png","pivot":Vector2(766.222,0),"scale":0.0390625},
		...
		{"name":"torso","parent":"neck","pos":Vector2(0,18),"rot":0,"len":110,"wid":42,"dir":-1,"color":Color(0.16,0.18,0.26),"tex":"res://assets/characters/sherlock/rig/sherlock_torso.png","pivot":Vector2(924.583,0),"scale":0.0738255},
		...
		{"name":"upperarm_L","parent":"shoulder_L","pos":Vector2(0,0),"rot":70,"len":60,"wid":16,"dir":1,"color":Color(0.24,0.26,0.36),"tex":"res://assets/characters/sherlock/rig/sherlock_upperarm_L.png","pivot":Vector2(718.132,0),"scale":0.0301054},
		{"name":"forearm_L","parent":"upperarm_L","pos":Vector2(0,60),"rot":8,"len":55,"wid":13,"dir":1,"color":Color(0.86,0.70,0.55),"tex":"res://assets/characters/sherlock/rig/sherlock_forearm_L.png","pivot":Vector2(486.126,0),"scale":0.0282051},
