...
func _on_verify_pressed() -> void:
	...
	var v := owner.get_verdict()
	owner._last_report = _compute_report(v)
	...
	pstyle.border_color = [owner.COL_RED, owner.COL_YELLOW, Color(0.4, 0.85, 0.4), owner.COL_GREEN][v] as Color
	...
	title.add_theme_color_override("font_color", [owner.COL_RED, owner.COL_YELLOW, Color(0.4, 0.85, 0.4), owner.COL_GREEN][v] as Color)
