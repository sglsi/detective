...
const FALLBACK_SEED := [
	...
	{"id": "KB-B-fb", "domain": "KB-B", "subdomain": "马车生态", "title": "维多利亚时代伦敦的马车生态", "keywords": ["马车", "轮距", "轴距", "汉索姆", "出租马车"], "summary": "汉索姆双轮全宽/轮距约5英尺11英寸–6英尺1英寸（无轴距）；四轮出租（brougham型）轴距约6英尺10英寸；私家大型马车约8英尺6英寸。", "body": "先分清三个量：轮距（track）决定两条车辙的横向间距；轴距（wheelbase）决定前后两组辙印的纵向间距，双轮车无轴距；轮径决定辙印宽度。轴距越短转弯半径越小——出租马车才能在小巷穿行。", "related": [], "tags": ["交通工具"]},
