...
func _seed_combinations() -> void:
	combinations = {
		# —— 场景二 花园（garden）——
		"tape+c202": "卷尺测量：轴距约6英尺10英寸（82英寸）、轮宽约2英寸——典型伦敦出租四轮马车（brougham型，轴距短利于钻小巷）",
		"tape+c205": "卷尺测量：方头靴步长2.6~2.9英尺、印长11.5×宽4英寸；尖头漆皮靴步长2.4~2.7英尺、印长11×宽3.5英寸——两人身高约6英尺与5英尺8英寸",
		"tape+c206": "卷尺测量：方头靴步长约2.75英尺→身高约6英尺（183cm）的壮汉",
		...
		"tape+c309": "卷尺测量：RACHE 字迹中心离地约5英尺7英寸半（171cm）——齐站立者眼高（≈身高×0.94）→ 书写者身高约6英尺",
		"tape+c311": "卷尺测量：方头靴步长约2.6~2.9英尺——与花园发现一致：六英尺高个子、方头靴",
