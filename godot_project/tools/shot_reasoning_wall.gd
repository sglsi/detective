...
func _initialize() -> void:
	...
	var data := {
		...
		{"id":"m1","name":"手臂锚文身","image":"res://assets/characters/messenger/messenger_portrait.png","anchor":"tattoo","correct":true,"associated":true,"related_npcs":["霍普"]},
	],
		...
		"state_store": {
			...
			"graph_placed_clues": ["c201","c202","c3","m1"],
